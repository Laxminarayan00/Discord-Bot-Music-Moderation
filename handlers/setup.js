...
module.exports = (client) => {
    ...
    function getAll(client, guild) {
        const embed = new MessageEmbed()
            ...
            .addField("• Important Links", `**[Invite Link](https://discord.com/api/oauth2/authorize?client_id=881006200626495528&permissions=8&scope=applications.commands%20bot)\`|\`[Support Server](https://discord.gg/aedr5e7JyS)\`|\`[Youtube](https://www.youtube.com/channel/UCYULbr7ZRPlzaZSf2NdDjWQ)\`**`)
